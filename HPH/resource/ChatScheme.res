Scheme
{
	...
	Colors
	{
		...
		Color_Btn                   "64 30 4 50" // custom for this scheme, see source in SourceScheme.res
		Color_BtnFocused            "150 84 32 50" // custom for this scheme, see source in SourceScheme.res
		Color_BtnPressed            "230 120 34 50" // custom for this scheme, see source in SourceScheme.res

		Color_Slider                "64 30 4 50" // custom for this scheme, see source in SourceScheme.res
		Color_SliderTrack           "20 10 0 50" // custom for this scheme, see source in SourceScheme.res

		Color_ActionElemBg          "44 32 18 50" // custom for this scheme, see source in SourceScheme.res
		Color_ActionElemBgSelected  "80 60 40 255"
